...
export default function HomePageClient({
  ...
  const siteUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://escapethebackrooms.wiki";
    ...
    "@graph": [
      {
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "Escape The Backrooms - Liminal Co-op Horror",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        image: {
          ...
          width: 1920,
          height: 1080,
          caption: "Escape The Backrooms Wiki - Liminal Co-op Horror",
        },
        sameAs: [
          "https://store.steampowered.com/app/1943950/Escape_the_Backrooms/",
          "https://discord.gg/fancygames",
          "https://www.reddit.com/r/backrooms/",
          "https://www.youtube.com/watch?v=2ZLPWJ-vkBU",
        ],
      },
      {
        "@type": "VideoGame",
      ...
      {
        "@type": "VideoObject",
        name: "Escape the Backrooms Official Trailer",
        description:
          "Official Escape The Backrooms video featuring the Steam launch trailer and gameplay preview.",
        uploadDate: "2022-08-11",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/2ZLPWJ-vkBU",
        url: "https://www.youtube.com/watch?v=2ZLPWJ-vkBU",
      },
    ],
  };
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 scroll-reveal">
            ...
            <div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:mb-12 md:gap-4">
              ...
              <a
                href="https://store.steampowered.com/app/1943950/Escape_the_Backrooms/"
                target="_blank"
      ...
      <section className="px-4 py-10 md:py-12">
        <div className="scroll-reveal container mx-auto max-w-5xl">
          <div className="relative overflow-hidden rounded-2xl">
            <VideoFeature
              videoId="2ZLPWJ-vkBU"
              title="Escape the Backrooms Official Trailer"
            />
          </div>
        </div>
      </section>
            ...
            {t.modules.lucidBlocksCreaturesAndEnemies.creatures.map(
              (c: any, index: number) => (
                ...
                >
                  <div className="mb-3">
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${["Hostile Enemy", "Major Threat", "Elite Threat"].includes(c.role) ? "bg-yellow-500/10 border-yellow-500/30 text-yellow-300" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {c.role}
                    </span>
                  </div>
              ...
              (p: any, index: number) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${p.priority === "Essential" ? "bg-yellow-500/10 border-yellow-500/30 text-yellow-300" : p.priority === "Very High" ? "bg-orange-500/10 border-orange-500/30 text-orange-400" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {p.priority}
                    </span>
                  </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://discord.gg/fancygames"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://steamcommunity.com/app/1943950"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
