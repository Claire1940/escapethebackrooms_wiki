...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Escape The Backrooms Wiki - Levels, Entities & Walkthrough",
    description:
      "Escape The Backrooms Wiki with level walkthroughs, entity counters, items, endings, achievements, co-op tips, and platform guides for PC, PS5, and Xbox.",
    robots: {
      index: true,
      follow: true,
      googleBot: {
      ...
      images: [
        {
          ...
          width: 1920,
          height: 1080,
          alt: "Escape The Backrooms - Liminal Co-op Horror",
        },
      ],
    },
    twitter: {
