...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Escape The Backrooms Wiki',
    description: 'Copyright and intellectual property information for Escape The Backrooms Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Escape The Backrooms Wiki',
      description: 'Copyright and intellectual property information for Escape The Backrooms Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Escape The Backrooms Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Escape The Backrooms Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Escape The Backrooms Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Escape The Backrooms Developers</strong> - Creators of the Escape The Backrooms game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Escape The Backrooms</strong> - Trademark of the game developers</li>
              <li><strong>Escape The Backrooms Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Escape The Backrooms Wiki.
            </p>
            ...
            <p>
              ...
              Escape The Backrooms Wiki<br />
              Email: <a href="mailto:dmca@escapethebackrooms.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@escapethebackrooms.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Escape The Backrooms Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Escape The Backrooms Wiki (escapethebackrooms.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@escapethebackrooms.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@escapethebackrooms.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@escapethebackrooms.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@escapethebackrooms.wiki</a>
            </p>
            <p>
