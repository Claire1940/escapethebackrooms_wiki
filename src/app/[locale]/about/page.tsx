...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://escapethebackrooms.wiki'
  const path = '/about'

  return {
    title: 'About Escape The Backrooms Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about Escape The Backrooms Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Escape The Backrooms Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'Escape The Backrooms Wiki',
      title: 'About Escape The Backrooms Wiki',
      description: 'Learn about our mission to provide the best Escape The Backrooms game resources and guides.',
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: 'Escape The Backrooms Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Escape The Backrooms Wiki',
      description: 'Learn about our mission to provide the best Escape The Backrooms game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About Escape The Backrooms Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Escape The Backrooms
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Escape The Backrooms Wiki</h2>
            <p>
              Escape The Backrooms Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam game "Escape The Backrooms". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Escape The Backrooms Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Escape The Backrooms players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Escape The Backrooms Wiki as the <strong>go-to destination</strong> for every Escape The Backrooms player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Escape The Backrooms Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Escape The Backrooms Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Escape The Backrooms as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Escape The Backrooms mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Escape The Backrooms Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Escape The Backrooms or any official entities.
            </p>
            <p>
            ...
            <p>
              Escape The Backrooms Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@escapethebackrooms.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@escapethebackrooms.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@escapethebackrooms.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@escapethebackrooms.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@escapethebackrooms.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@escapethebackrooms.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@escapethebackrooms.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@escapethebackrooms.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Escape The Backrooms news.
