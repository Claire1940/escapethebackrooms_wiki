...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://escapethebackrooms.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Escape The Backrooms Wiki'
